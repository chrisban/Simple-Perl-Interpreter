...
#plusC
print "plusC(numC(1), plusC(numC(5), numC(4)) = ";
my $plusCP = plusC->new(numC->new(1), plusC->new(numC->new(5), numC->new(4)));

my $result1 = $plusCP->interp();

print  $result1 . "\n";

Test::Simple::ok($result1 == 10);
...
#multC
print "multC(numC(2), multC(numC(5), numC(4)) = ";
my $plusCP = multC->new(numC->new(2), multC->new(numC->new(5), numC->new(4)));

my $result2 = $plusCP->interp();

print  $result2 . "\n";

Test::Simple::ok($result2 == 40);

print "\n\n";


#appC
print "FDC: id: fnc, param: x, body: plusC(numc(2), idC('x'))\nAPPC: name: fnc, arg: numC->new(4)\nShould create: PlusC(numC(2), numC(4)) = ";
my $fdcP = fdC->new('fnc','x', new plusC(numC->new(2),  new idC ('x')));
my $appCP = appC->new('fnc', numC->new(4));

my @fdcArr;
push(@fdcArr, $fdcP);

my $result3 = $appCP->interp(@fdcArr);

print  $result3 . "\n";

Test::Simple::ok($result3 == 6);